...
package com.equipmentmanage.app.service;
...
public class BluetoothChatService {
    // Debugging
    private static final String TAG = "zzz1--blueser->";
    ...
    public synchronized void connectDevice(BluetoothDevice device) {
        ...
        sendMessageToUi(ConstantValue.BLUE_TOOTH_DIALOG , "正在与" + device.getName() + "连接");
                    ...
                    synchronized (BluetoothChatService.this) {
                        switch (mState) {
                            ...
                            case STATE_CONNECTING:
                                ...
                                sendMessageToUi(ConstantValue.BLUE_TOOTH_DIALOG , "正在与" + socket.getRemoteDevice().getName() + "连接");
    ...
    private void dataTransfer(BluetoothSocket socket,final BluetoothDevice remoteDevice) {
        ...
        uiHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(!isTransferError){
                    sendMessageToUi(ConstantValue.BLUE_TOOTH_SUCCESS , remoteDevice.getName());
                }
            }
        } , 300);
    }
    ...
    class TransferThread extends Thread{
        ...
        public void run() {
            ...
            while (true){
                try {
                    ...
                    //TODO 分发到主线程显示
                    uiHandler.obtainMessage(ConstantValue.BLUE_TOOTH_READ, bytes, -1, buffer)
                            .sendToTarget();
                    ...
                    //TODO 连接丢失显示并重新开始连接
                    sendMessageToUi(ConstantValue.BLUE_TOOTH_TOAST , "设备连接失败/传输关闭");
        ...
        public void write(byte[] buffer) {
            try {
                out.write(buffer);
                //TODO 到到UI显示
                uiHandler.obtainMessage(ConstantValue.BLUE_TOOTH_WRAITE , -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
    ...
    class ConnectThread extends Thread{
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                sendMessageToUi(ConstantValue.BLUE_TOOTH_TOAST , "连接失败，请重新连接");
            }
            socket = mSocket;
        }
