...
/**
 * @Description: 选择楼层-adapter
 * @Author: zzh
 * @CreateDate: 2021/12/13
 */
public class FloorSelectAdapter extends BaseQuickAdapter<CommonSelectBean, BaseViewHolder> {
    public FloorSelectAdapter(@Nullable List<CommonSelectBean> data) {
        super(R.layout.item_common_select1, data);
    }
