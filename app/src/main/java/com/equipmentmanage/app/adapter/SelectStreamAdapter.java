 ...
 */
public class SelectStreamAdapter extends BaseEditSpinnerAdapter implements EditSpinnerFilter {

    private Context mContext;
    private List<BaseStreamBean> mList;

    public SelectStreamAdapter(Context context, List<BaseStreamBean> list) {
        super(list);
    ...
    public String getItemString(int position) {
        return mList.get(position).getProdStreamName();
    }
    ...
    public String getItem(int position) {
        return mList == null ? "" : mList.get(position) == null ? "" : mList.get(position).getProdStreamName();
    }
...
//        textView.setText(Html.fromHtml(getItem(position)));
        viewHolder.tv_name.setText(StringUtils.nullStrToEmpty(mList.get(position).getProdStreamName()));
        return convertView;
    }
