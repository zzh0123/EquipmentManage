...
//        holder.setText(R.id.tv_complete_progress, StringUtils.nullStrToEmpty(bean.getDepartment())); // 任务完成进度
//        holder.setText(R.id.tv_label_info, StringUtils.nullStrToEmpty(bean.getDeviceType_dictText())); // 标签信息
        holder.setText(R.id.tv_upload_date, StringUtils.nullStrToEmpty(bean.getCreateTime())); // 上传时间
