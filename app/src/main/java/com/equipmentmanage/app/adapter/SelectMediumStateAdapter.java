...
/**
 * @Description: 介质状态-adapter
 * @Author: zzh
 * @CreateDate: 2021/12/26
 */
public class SelectMediumStateAdapter extends BaseEditSpinnerAdapter implements EditSpinnerFilter {

    private Context mContext;
    private List<BaseMediumStateBean> mList;

    public SelectMediumStateAdapter(Context context, List<BaseMediumStateBean> list) {
        super(list);
