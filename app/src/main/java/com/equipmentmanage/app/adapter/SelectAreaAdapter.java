 ...
 */
public class SelectAreaAdapter extends BaseEditSpinnerAdapter implements EditSpinnerFilter {

    private Context mContext;
    private List<BaseAreaBean> mList;

    public SelectAreaAdapter(Context context, List<BaseAreaBean> list) {
        super(list);
    ...
    public String getItemString(int position) {
        return mList.get(position).getAreaName();
    }
    ...
    public String getItem(int position) {
        return mList == null ? "" : mList.get(position) == null ? "" : mList.get(position).getAreaName();
    }
...
//        textView.setText(Html.fromHtml(getItem(position)));
        viewHolder.tv_name.setText(StringUtils.nullStrToEmpty(mList.get(position).getAreaName()));
        return convertView;
    }
