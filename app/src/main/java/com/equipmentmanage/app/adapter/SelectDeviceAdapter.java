 ...
 */
public class SelectDeviceAdapter extends BaseEditSpinnerAdapter implements EditSpinnerFilter {

    private Context mContext;
    private List<BaseDeviceBean> mList;

    public SelectDeviceAdapter(Context context, List<BaseDeviceBean> list) {
        super(list);
    ...
    public String getItemString(int position) {
        return mList.get(position).getDeviceName();
    }
    ...
    public String getItem(int position) {
        return mList == null ? "" : mList.get(position) == null ? "" : mList.get(position).getDeviceName();
    }
...
//        textView.setText(Html.fromHtml(getItem(position)));
        viewHolder.tv_name.setText(StringUtils.nullStrToEmpty(mList.get(position).getDeviceName()));
        return convertView;
    }
