...
import com.equipmentmanage.app.db.gen.DaoSession;
...
public class CommonDaoUtils<T> {
    ...
    private AbstractDao<T, String> entityDao;

    public CommonDaoUtils(Class<T> pEntityClass, AbstractDao<T, String> pEntityDao) {
